...
export default function Home() {
  ...
  const handleLinkClick = () => {
    setNavbar(false); // Hide the navbar when a link is clicked
  };
    ...
    <div>
      <nav
        className={`w-full bg-slate-200  shadow ${
          navbar ? "fixed top-0 slide-right" : "relative"
        }`}
      >
        <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
          <div>
            <div className="flex items-center justify-between py-3 md:py-5 md:block">
              <Link href="/">
                <h2 className="text-2xl text-gray-700 hover:text-black  font-bold">
                  WHT Calculator
                </h2>
              </Link>
              <div className="md:hidden">
          ...
          <div
            className={`relative ${
              navbar ? "block slide-right" : "hidden"
          ...
          <div>
            ...
            >
              <ul className="items-center justify-center text-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                ...
                >
                  <Link href="/salary" onClick={handleLinkClick}>
                    Salary
                  </Link>
                </li>
                <li
                ...
                >
                  <Link href="/property" onClick={handleLinkClick}>
                    Property
                  </Link>
                </li>
                <li
                ...
                >
                  <Link href="/business" onClick={handleLinkClick}>
                    Business
                  </Link>
                </li>
                <li
                ...
                >
                  <Link href="/other" onClick={handleLinkClick}>
                    Other
                  </Link>
                </li>
              </ul>
